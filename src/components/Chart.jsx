...
const Chart = ({
  stat, activeCountry, globalHistory, countryHistoryStat,
}) => {
  ...
  useLayoutEffect(() => {
    const x = am4core.create('chartComp', am4charts.XYChart);
    x.paddingLeft = 0;
    x.data = data;

    x.zoomOutButton.icon.disabled = true;
    const zoomImage = x.zoomOutButton.createChild(am4core.Image);
